...
@dsl.pipeline(name="adult_income_lr")
def adult_income_lr():
    ...
    # data_preprocessing_task = data_preprocessing_task.set_memory_request("15074Ki")
    # model_training_task = model_training_task.set_memory_request("12058Ki")
    # model_evaluation_task = model_evaluation_task.set_memory_request("3014Ki")


client = Client(host="http://kfp.local")
run = client.create_run_from_pipeline_func(
    pipeline_func=adult_income_lr, enable_caching=False
)
